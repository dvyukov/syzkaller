...
generate_rpc:
	flatc --warnings-as-errors --gen-object-api --filename-suffix "" --go --gen-onefile --go-namespace flatrpc -o pkg/flatrpc pkg/flatrpc/flatrpc.fbs
	flatc --warnings-as-errors --gen-object-api --filename-suffix "" --cpp --scoped-enums -o executor pkg/flatrpc/flatrpc.fbs
