...
#define GOARCH "386"
#define SYZ_REVISION "5cb311a2842103b41185688fdd5b508f5e132829"
#define SYZ_PAGE_SIZE 4096
#define SYZ_NUM_PAGES 4096
#define SYZ_DATA_OFFSET 536870912
unsigned syscall_count = 1862;
call_t syscalls[] = {
    {"accept4", 364},
    {"accept4$GENERIC", 364},
    {"accept4$alg", 364},
    ...
    {"chroot$GENERIC", 61},
    {"clock_adjtime", 343},
    {"clock_adjtime$GENERIC", 343},
    {"clock_getres", 266},
    {"clock_getres$GENERIC", 266},
    {"clock_gettime", 265},
    {"clock_gettime$GENERIC", 265},
    {"clock_nanosleep", 267},
    {"clock_nanosleep$GENERIC", 267},
    {"clock_settime", 264},
    {"clock_settime$GENERIC", 264},
    {"clone", 120},
    {"clone$GENERIC", 120},
    {"close", 6},
    {"close$GENERIC", 6},
    ...
    {"dup3$GENERIC", 330},
    {"epoll_create", 254},
    {"epoll_create$GENERIC", 254},
    {"epoll_create1", 329},
    {"epoll_create1$GENERIC", 329},
    {"epoll_ctl$EPOLL_CTL_ADD", 255},
    {"epoll_ctl$EPOLL_CTL_DEL", 255},
    {"epoll_ctl$EPOLL_CTL_MOD", 255},
    {"epoll_ctl$GENERIC", 255},
    {"epoll_pwait", 319},
    {"epoll_pwait$GENERIC", 319},
    {"epoll_wait", 256},
    {"epoll_wait$GENERIC", 256},
    {"eventfd", 323},
    {"eventfd$GENERIC", 323},
    {"eventfd2", 328},
    {"eventfd2$GENERIC", 328},
    {"execve", 11},
    {"execve$GENERIC", 11},
    {"execveat", 358},
    {"execveat$GENERIC", 358},
    {"exit", 1},
    {"exit$GENERIC", 1},
    {"exit_group", 252},
    {"exit_group$GENERIC", 252},
    {"faccessat", 307},
    {"faccessat$GENERIC", 307},
    {"fadvise64", 250},
    {"fadvise64$GENERIC", 250},
    {"fallocate", 324},
    {"fallocate$GENERIC", 324},
    {"fanotify_init", 338},
    {"fanotify_init$GENERIC", 338},
    {"fanotify_mark", 339},
    {"fanotify_mark$GENERIC", 339},
    {"fchdir", 133},
    {"fchdir$GENERIC", 133},
    {"fchmod", 94},
    {"fchmod$GENERIC", 94},
    {"fchmodat", 306},
    {"fchmodat$GENERIC", 306},
    {"fchown", 95},
    {"fchown$GENERIC", 95},
    {"fchownat", 298},
    {"fchownat$GENERIC", 298},
    ...
    {"fcntl$setstatus", 55},
    {"fdatasync", 148},
    {"fdatasync$GENERIC", 148},
    {"fgetxattr", 231},
    {"fgetxattr$GENERIC", 231},
    {"finit_module", 350},
    {"finit_module$GENERIC", 350},
    {"flistxattr", 234},
    {"flistxattr$GENERIC", 234},
    {"flock", 143},
    {"flock$GENERIC", 143},
    {"fremovexattr", 237},
    {"fremovexattr$GENERIC", 237},
    {"fsetxattr", 228},
    {"fsetxattr$GENERIC", 228},
    {"fstat", 108},
    {"fstat$GENERIC", 108},
    {"fstatfs", 100},
    {"fstatfs$GENERIC", 100},
    ...
    {"fsync$GENERIC", 118},
    {"ftruncate", 93},
    {"ftruncate$GENERIC", 93},
    {"futex", 240},
    {"futex$GENERIC", 240},
    {"futimesat", 299},
    {"futimesat$GENERIC", 299},
    {"get_mempolicy", 275},
    {"get_mempolicy$GENERIC", 275},
    {"get_robust_list", 312},
    {"get_robust_list$GENERIC", 312},
    {"get_thread_area", 244},
    {"get_thread_area$GENERIC", 244},
    {"getcwd", 183},
    {"getcwd$GENERIC", 183},
    {"getdents", 141},
    {"getdents$GENERIC", 141},
    {"getdents64", 220},
    {"getdents64$GENERIC", 220},
    {"getegid", 50},
    {"geteuid", 49},
    {"getgid", 47},
    {"getgroups", 80},
    {"getgroups$GENERIC", 80},
    {"getitimer", 105},
    {"getitimer$GENERIC", 105},
    {"getpeername", 368},
    {"getpeername$GENERIC", 368},
    ...
    {"getpid", 20},
    {"getpriority", 96},
    {"getpriority$GENERIC", 96},
    {"getrandom", 355},
    {"getrandom$GENERIC", 355},
    {"getresgid", 171},
    {"getresgid$GENERIC", 171},
    {"getresuid", 165},
    {"getresuid$GENERIC", 165},
    {"getrlimit", 76},
    {"getrlimit$GENERIC", 76},
    {"getrusage", 77},
    {"getrusage$GENERIC", 77},
    {"getsockname", 367},
    {"getsockname$GENERIC", 367},
    ...
    {"getuid", 24},
    {"getxattr", 229},
    {"getxattr$GENERIC", 229},
    {"init_module", 128},
    {"init_module$GENERIC", 128},
    {"inotify_add_watch", 292},
    {"inotify_add_watch$GENERIC", 292},
    {"inotify_init", 291},
    {"inotify_init1", 332},
    {"inotify_init1$GENERIC", 332},
    {"inotify_rm_watch", 293},
    {"inotify_rm_watch$GENERIC", 293},
    {"io_cancel", 249},
    {"io_cancel$GENERIC", 249},
    {"io_destroy", 246},
    {"io_destroy$GENERIC", 246},
    {"io_getevents", 247},
    {"io_getevents$GENERIC", 247},
    {"io_setup", 245},
    {"io_setup$GENERIC", 245},
    {"io_submit", 248},
    {"io_submit$GENERIC", 248},
    {"ioctl", 54},
    ...
    {"iopl", 110},
    {"iopl$GENERIC", 110},
    {"ioprio_get$GENERIC", 290},
    {"ioprio_get$pid", 290},
    {"ioprio_get$uid", 290},
    {"ioprio_set$GENERIC", 289},
    {"ioprio_set$pid", 289},
    {"ioprio_set$uid", 289},
    {"kcmp", 349},
    {"kcmp$GENERIC", 349},
    ...
    {"listen$netrom", 363},
    {"listxattr", 232},
    {"listxattr$GENERIC", 232},
    {"llistxattr", 233},
    {"llistxattr$GENERIC", 233},
    {"lookup_dcookie", 253},
    {"lookup_dcookie$GENERIC", 253},
    {"lremovexattr", 236},
    {"lremovexattr$GENERIC", 236},
    {"lseek", 19},
    {"lseek$GENERIC", 19},
    {"lsetxattr", 227},
    {"lsetxattr$GENERIC", 227},
    {"lstat", 107},
    {"lstat$GENERIC", 107},
    {"madvise", 219},
    {"madvise$GENERIC", 219},
    ...
    {"mbind$GENERIC", 274},
    {"membarrier", 375},
    {"membarrier$GENERIC", 375},
    {"memfd_create", 356},
    {"memfd_create$GENERIC", 356},
    {"migrate_pages", 294},
    {"migrate_pages$GENERIC", 294},
    {"mincore", 218},
    {"mincore$GENERIC", 218},
    {"mkdir", 39},
    {"mkdir$GENERIC", 39},
    ...
    {"mlock2$GENERIC", 376},
    {"mlockall", 152},
    {"mlockall$GENERIC", 152},
    {"mmap", 192},
    {"mmap$GENERIC", 192},
    {"mmap$binder", 192},
    {"modify_ldt$GENERIC", 123},
    {"modify_ldt$read", 123},
    ...
    {"mount$GENERIC", 21},
    {"move_pages", 317},
    {"move_pages$GENERIC", 317},
    {"mprotect", 125},
    {"mprotect$GENERIC", 125},
    {"mq_getsetattr", 282},
    {"mq_getsetattr$GENERIC", 282},
    {"mq_notify", 281},
    {"mq_notify$GENERIC", 281},
    {"mq_open", 277},
    {"mq_open$GENERIC", 277},
    {"mq_timedreceive", 280},
    {"mq_timedreceive$GENERIC", 280},
    {"mq_timedsend", 279},
    {"mq_timedsend$GENERIC", 279},
    {"mq_unlink", 278},
    {"mq_unlink$GENERIC", 278},
    {"mremap", 163},
    {"mremap$GENERIC", 163},
    {"msync", 144},
    {"msync$GENERIC", 144},
    ...
    {"name_to_handle_at$GENERIC", 341},
    {"nanosleep", 162},
    {"nanosleep$GENERIC", 162},
    {"open", 5},
    {"open$GENERIC", 5},
    {"open$dir", 5},
    {"open_by_handle_at", 342},
    {"open_by_handle_at$GENERIC", 342},
    {"openat", 295},
    {"openat$GENERIC", 295},
    {"openat$ashmem", 295},
    {"openat$audio", 295},
    ...
    {"pause", 29},
    {"perf_event_open", 336},
    {"perf_event_open$GENERIC", 336},
    {"personality", 136},
    {"personality$GENERIC", 136},
    {"pipe", 42},
    {"pipe$GENERIC", 42},
    {"pipe2", 331},
    {"pipe2$GENERIC", 331},
    {"pivot_root", 217},
    {"pivot_root$GENERIC", 217},
    {"pkey_alloc", 381},
    {"pkey_alloc$GENERIC", 381},
    {"pkey_free", 382},
    {"pkey_free$GENERIC", 382},
    {"pkey_mprotect", 380},
    {"pkey_mprotect$GENERIC", 380},
    {"poll", 168},
    {"poll$GENERIC", 168},
    {"ppoll", 309},
    {"ppoll$GENERIC", 309},
    ...
    {"preadv$GENERIC", 333},
    {"prlimit64", 340},
    {"prlimit64$GENERIC", 340},
    {"process_vm_readv", 347},
    {"process_vm_readv$GENERIC", 347},
    {"process_vm_writev", 348},
    {"process_vm_writev$GENERIC", 348},
    {"pselect6", 308},
    {"pselect6$GENERIC", 308},
    {"ptrace", 26},
    {"ptrace$GENERIC", 26},
    ...
    {"ptrace$setsig", 26},
    {"pwrite64", 181},
    {"pwrite64$GENERIC", 181},
    {"pwritev", 334},
    {"pwritev$GENERIC", 334},
    {"quotactl", 131},
    {"quotactl$GENERIC", 131},
    {"read", 3},
    {"read$GENERIC", 3},
    {"read$eventfd", 3},
    {"readahead", 225},
    {"readahead$GENERIC", 225},
    {"readlink", 85},
    {"readlink$GENERIC", 85},
    {"readlinkat", 305},
    {"readlinkat$GENERIC", 305},
    {"readv", 145},
    {"readv$GENERIC", 145},
    {"recvfrom", 371},
    {"recvfrom$GENERIC", 371},
    {"recvfrom$ax25", 371},
    {"recvfrom$inet", 371},
    {"recvfrom$inet6", 371},
    {"recvfrom$ipx", 371},
    ...
    {"recvfrom$unix", 371},
    {"recvmmsg", 337},
    {"recvmmsg$GENERIC", 337},
    {"recvmsg", 372},
    {"recvmsg$GENERIC", 372},
    {"recvmsg$kcm", 372},
    {"recvmsg$netrom", 372},
    {"remap_file_pages", 257},
    {"remap_file_pages$GENERIC", 257},
    {"removexattr", 235},
    {"removexattr$GENERIC", 235},
    {"rename", 38},
    {"rename$GENERIC", 38},
    {"renameat", 302},
    {"renameat$GENERIC", 302},
    {"renameat2", 353},
    {"renameat2$GENERIC", 353},
    {"request_key", 287},
    {"request_key$GENERIC", 287},
    {"restart_syscall", 0},
    {"rmdir", 40},
    {"rmdir$GENERIC", 40},
    {"rt_sigaction", 174},
    {"rt_sigaction$GENERIC", 174},
    {"rt_sigpending", 176},
    {"rt_sigpending$GENERIC", 176},
    {"rt_sigprocmask", 175},
    {"rt_sigprocmask$GENERIC", 175},
    {"rt_sigqueueinfo", 178},
    {"rt_sigqueueinfo$GENERIC", 178},
    {"rt_sigreturn", 173},
    {"rt_sigsuspend", 179},
    {"rt_sigsuspend$GENERIC", 179},
    {"rt_sigtimedwait", 177},
    {"rt_sigtimedwait$GENERIC", 177},
    {"rt_tgsigqueueinfo", 335},
    {"rt_tgsigqueueinfo$GENERIC", 335},
    {"sched_getaffinity", 242},
    {"sched_getaffinity$GENERIC", 242},
    {"sched_getattr", 352},
    {"sched_getattr$GENERIC", 352},
    {"sched_getparam", 155},
    {"sched_getparam$GENERIC", 155},
    {"sched_getscheduler", 157},
    {"sched_getscheduler$GENERIC", 157},
    {"sched_rr_get_interval", 161},
    {"sched_rr_get_interval$GENERIC", 161},
    {"sched_setaffinity", 241},
    {"sched_setaffinity$GENERIC", 241},
    {"sched_setattr", 351},
    {"sched_setattr$GENERIC", 351},
    {"sched_setparam", 154},
    {"sched_setparam$GENERIC", 154},
    {"sched_setscheduler", 156},
    {"sched_setscheduler$GENERIC", 156},
    {"sched_yield", 158},
    {"seccomp", 354},
    {"seccomp$GENERIC", 354},
    {"select", 82},
    {"select$GENERIC", 82},
    {"sendfile", 187},
    {"sendfile$GENERIC", 187},
    {"sendfile64", 239},
    {"sendfile64$GENERIC", 239},
    {"sendmmsg", 345},
    {"sendmmsg$GENERIC", 345},
    {"sendmmsg$alg", 345},
    ...
    {"sendto$unix", 369},
    {"set_mempolicy", 276},
    {"set_mempolicy$GENERIC", 276},
    {"set_robust_list", 311},
    {"set_robust_list$GENERIC", 311},
    {"set_thread_area", 243},
    {"set_thread_area$GENERIC", 243},
    {"set_tid_address", 258},
    {"set_tid_address$GENERIC", 258},
    {"setfsgid", 139},
    {"setfsgid$GENERIC", 139},
    {"setfsuid", 138},
    {"setfsuid$GENERIC", 138},
    {"setgid", 46},
    {"setgid$GENERIC", 46},
    {"setgroups", 81},
    {"setgroups$GENERIC", 81},
    {"setitimer", 104},
    {"setitimer$GENERIC", 104},
    {"setns", 346},
    {"setns$GENERIC", 346},
    {"setpgid", 57},
    {"setpgid$GENERIC", 57},
    {"setpriority", 97},
    {"setpriority$GENERIC", 97},
    {"setregid", 71},
    {"setregid$GENERIC", 71},
    {"setresgid", 170},
    {"setresgid$GENERIC", 170},
    {"setresuid", 164},
    {"setresuid$GENERIC", 164},
    {"setreuid", 70},
    {"setreuid$GENERIC", 70},
    {"setrlimit", 75},
    {"setrlimit$GENERIC", 75},
    {"setsockopt", 366},
    ...
    {"setuid$GENERIC", 23},
    {"setxattr", 226},
    {"setxattr$GENERIC", 226},
    {"shutdown", 373},
    {"shutdown$GENERIC", 373},
    {"sigaltstack", 186},
    {"sigaltstack$GENERIC", 186},
    {"signalfd", 321},
    {"signalfd$GENERIC", 321},
    {"signalfd4", 327},
    {"signalfd4$GENERIC", 327},
    {"socket", 359},
    {"socket$GENERIC", 359},
    {"socket$alg", 359},
    {"socket$ax25", 359},
    ...
    {"symlink$GENERIC", 83},
    {"symlinkat", 304},
    {"symlinkat$GENERIC", 304},
    {"sync", 36},
    {"sync_file_range", 314},
    {"sync_file_range$GENERIC", 314},
    {"syncfs", 344},
    {"syncfs$GENERIC", 344},
    {"sysfs$1", 135},
    {"sysfs$2", 135},
    ...
    {"syz_emit_ethernet$GENERIC", 0, (syscall_t)syz_emit_ethernet},
    {"syz_extract_tcp_res", 0, (syscall_t)syz_extract_tcp_res},
    {"syz_extract_tcp_res$GENERIC", 0, (syscall_t)syz_extract_tcp_res},
    {"syz_extract_tcp_res$synack", 0, (syscall_t)syz_extract_tcp_res},
    {"syz_fuse_mount", 0, (syscall_t)syz_fuse_mount},
    {"syz_fuse_mount$GENERIC", 0, (syscall_t)syz_fuse_mount},
    {"syz_fuseblk_mount", 0, (syscall_t)syz_fuseblk_mount},
    {"syz_fuseblk_mount$GENERIC", 0, (syscall_t)syz_fuseblk_mount},
    {"syz_kvm_setup_cpu$GENERIC", 0, (syscall_t)syz_kvm_setup_cpu},
    {"syz_kvm_setup_cpu$arm64", 0, (syscall_t)syz_kvm_setup_cpu},
    {"syz_kvm_setup_cpu$x86", 0, (syscall_t)syz_kvm_setup_cpu},
    {"syz_open_dev$GENERIC", 0, (syscall_t)syz_open_dev},
    ...
    {"syz_open_procfs$GENERIC", 0, (syscall_t)syz_open_procfs},
    {"syz_open_pts", 0, (syscall_t)syz_open_pts},
    {"syz_open_pts$GENERIC", 0, (syscall_t)syz_open_pts},
    {"tee", 315},
    {"tee$GENERIC", 315},
    {"tgkill", 270},
    {"tgkill$GENERIC", 270},
    ...
    {"time$GENERIC", 13},
    {"timer_create", 259},
    {"timer_create$GENERIC", 259},
    {"timer_delete", 263},
    {"timer_delete$GENERIC", 263},
    {"timer_getoverrun", 262},
    {"timer_getoverrun$GENERIC", 262},
    {"timer_gettime", 261},
    {"timer_gettime$GENERIC", 261},
    {"timer_settime", 260},
    {"timer_settime$GENERIC", 260},
    {"timerfd_create", 322},
    {"timerfd_create$GENERIC", 322},
    {"timerfd_gettime", 326},
    {"timerfd_gettime$GENERIC", 326},
    {"timerfd_settime", 325},
    {"timerfd_settime$GENERIC", 325},
    {"times", 43},
    {"times$GENERIC", 43},
    {"tkill", 238},
    {"tkill$GENERIC", 238},
    ...
    {"unlink$GENERIC", 10},
    {"unlinkat", 301},
    {"unlinkat$GENERIC", 301},
    {"unshare", 310},
    {"unshare$GENERIC", 310},
    {"uselib", 86},
    {"uselib$GENERIC", 86},
    {"userfaultfd", 374},
    {"userfaultfd$GENERIC", 374},
    {"ustat", 62},
    {"ustat$GENERIC", 62},
    {"utime", 30},
    {"utime$GENERIC", 30},
    {"utimensat", 320},
    {"utimensat$GENERIC", 320},
    {"utimes", 271},
    {"utimes$GENERIC", 271},
    {"vmsplice", 316},
    {"vmsplice$GENERIC", 316},
    {"wait4", 114},
    {"wait4$GENERIC", 114},
    {"waitid", 284},
    {"waitid$GENERIC", 284},
...
#define GOARCH "amd64"
#define SYZ_REVISION "6a66115ab58b718ad8834e1dbbfdd22311ec651e"
#define SYZ_PAGE_SIZE 4096
#define SYZ_NUM_PAGES 4096
#define SYZ_DATA_OFFSET 536870912
unsigned syscall_count = 1927;
call_t syscalls[] = {
    {"accept", 43},
    {"accept$GENERIC", 43},
    {"accept$alg", 43},
    ...
    {"chroot$GENERIC", 161},
    {"clock_adjtime", 305},
    {"clock_adjtime$GENERIC", 305},
    {"clock_getres", 229},
    {"clock_getres$GENERIC", 229},
    {"clock_gettime", 228},
    {"clock_gettime$GENERIC", 228},
    {"clock_nanosleep", 230},
    {"clock_nanosleep$GENERIC", 230},
    {"clock_settime", 227},
    {"clock_settime$GENERIC", 227},
    {"clone", 56},
    {"clone$GENERIC", 56},
    {"close", 3},
    {"close$GENERIC", 3},
    ...
    {"dup3$GENERIC", 292},
    {"epoll_create", 213},
    {"epoll_create$GENERIC", 213},
    {"epoll_create1", 291},
    {"epoll_create1$GENERIC", 291},
    {"epoll_ctl$EPOLL_CTL_ADD", 233},
    {"epoll_ctl$EPOLL_CTL_DEL", 233},
    {"epoll_ctl$EPOLL_CTL_MOD", 233},
    {"epoll_ctl$GENERIC", 233},
    {"epoll_pwait", 281},
    {"epoll_pwait$GENERIC", 281},
    {"epoll_wait", 232},
    {"epoll_wait$GENERIC", 232},
    {"eventfd", 284},
    {"eventfd$GENERIC", 284},
    {"eventfd2", 290},
    {"eventfd2$GENERIC", 290},
    {"execve", 59},
    {"execve$GENERIC", 59},
    {"execveat", 322},
    {"execveat$GENERIC", 322},
    {"exit", 60},
    {"exit$GENERIC", 60},
    {"exit_group", 231},
    {"exit_group$GENERIC", 231},
    {"faccessat", 269},
    {"faccessat$GENERIC", 269},
    {"fadvise64", 221},
    {"fadvise64$GENERIC", 221},
    {"fallocate", 285},
    {"fallocate$GENERIC", 285},
    {"fanotify_init", 300},
    {"fanotify_init$GENERIC", 300},
    {"fanotify_mark", 301},
    {"fanotify_mark$GENERIC", 301},
    {"fchdir", 81},
    {"fchdir$GENERIC", 81},
    {"fchmod", 91},
    {"fchmod$GENERIC", 91},
    {"fchmodat", 268},
    {"fchmodat$GENERIC", 268},
    {"fchown", 93},
    {"fchown$GENERIC", 93},
    {"fchownat", 260},
    {"fchownat$GENERIC", 260},
    ...
    {"fcntl$setstatus", 72},
    {"fdatasync", 75},
    {"fdatasync$GENERIC", 75},
    {"fgetxattr", 193},
    {"fgetxattr$GENERIC", 193},
    {"finit_module", 313},
    {"finit_module$GENERIC", 313},
    {"flistxattr", 196},
    {"flistxattr$GENERIC", 196},
    {"flock", 73},
    {"flock$GENERIC", 73},
    {"fremovexattr", 199},
    {"fremovexattr$GENERIC", 199},
    {"fsetxattr", 190},
    {"fsetxattr$GENERIC", 190},
    {"fstat", 5},
    {"fstat$GENERIC", 5},
    {"fstatfs", 138},
    {"fstatfs$GENERIC", 138},
    ...
    {"fsync$GENERIC", 74},
    {"ftruncate", 77},
    {"ftruncate$GENERIC", 77},
    {"futex", 202},
    {"futex$GENERIC", 202},
    {"futimesat", 261},
    {"futimesat$GENERIC", 261},
    {"get_mempolicy", 239},
    {"get_mempolicy$GENERIC", 239},
    {"get_robust_list", 274},
    {"get_robust_list$GENERIC", 274},
    {"get_thread_area", 211},
    {"get_thread_area$GENERIC", 211},
    {"getcwd", 79},
    {"getcwd$GENERIC", 79},
    {"getdents", 78},
    {"getdents$GENERIC", 78},
    {"getdents64", 217},
    {"getdents64$GENERIC", 217},
    {"getegid", 108},
    {"geteuid", 107},
    {"getgid", 104},
    {"getgroups", 115},
    {"getgroups$GENERIC", 115},
    {"getitimer", 36},
    {"getitimer$GENERIC", 36},
    {"getpeername", 52},
    {"getpeername$GENERIC", 52},
    {"getpeername$ax25", 52},
    {"getpeername$inet", 52},
    ...
    {"getpid", 39},
    {"getpriority", 140},
    {"getpriority$GENERIC", 140},
    {"getrandom", 318},
    {"getrandom$GENERIC", 318},
    {"getresgid", 120},
    {"getresgid$GENERIC", 120},
    {"getresuid", 118},
    {"getresuid$GENERIC", 118},
    {"getrlimit", 97},
    {"getrlimit$GENERIC", 97},
    {"getrusage", 98},
    {"getrusage$GENERIC", 98},
    {"getsockname", 51},
    {"getsockname$GENERIC", 51},
    {"getsockname$ax25", 51},
    {"getsockname$inet", 51},
    ...
    {"getuid", 102},
    {"getxattr", 191},
    {"getxattr$GENERIC", 191},
    {"init_module", 175},
    {"init_module$GENERIC", 175},
    {"inotify_add_watch", 254},
    {"inotify_add_watch$GENERIC", 254},
    {"inotify_init", 253},
    {"inotify_init1", 294},
    {"inotify_init1$GENERIC", 294},
    {"inotify_rm_watch", 255},
    {"inotify_rm_watch$GENERIC", 255},
    {"io_cancel", 210},
    {"io_cancel$GENERIC", 210},
    {"io_destroy", 207},
    {"io_destroy$GENERIC", 207},
    {"io_getevents", 208},
    {"io_getevents$GENERIC", 208},
    {"io_setup", 206},
    {"io_setup$GENERIC", 206},
    {"io_submit", 209},
    {"io_submit$GENERIC", 209},
    {"ioctl", 16},
    ...
    {"iopl", 172},
    {"iopl$GENERIC", 172},
    {"ioprio_get$GENERIC", 252},
    {"ioprio_get$pid", 252},
    {"ioprio_get$uid", 252},
    {"ioprio_set$GENERIC", 251},
    {"ioprio_set$pid", 251},
    {"ioprio_set$uid", 251},
    {"kcmp", 312},
    {"kcmp$GENERIC", 312},
    ...
    {"listen$netrom", 50},
    {"listxattr", 194},
    {"listxattr$GENERIC", 194},
    {"llistxattr", 195},
    {"llistxattr$GENERIC", 195},
    {"lookup_dcookie", 212},
    {"lookup_dcookie$GENERIC", 212},
    {"lremovexattr", 198},
    {"lremovexattr$GENERIC", 198},
    {"lseek", 8},
    {"lseek$GENERIC", 8},
    {"lsetxattr", 189},
    {"lsetxattr$GENERIC", 189},
    {"lstat", 6},
    {"lstat$GENERIC", 6},
    {"madvise", 28},
    {"madvise$GENERIC", 28},
    ...
    {"mbind$GENERIC", 237},
    {"membarrier", 324},
    {"membarrier$GENERIC", 324},
    {"memfd_create", 319},
    {"memfd_create$GENERIC", 319},
    {"migrate_pages", 256},
    {"migrate_pages$GENERIC", 256},
    {"mincore", 27},
    {"mincore$GENERIC", 27},
    {"mkdir", 83},
    {"mkdir$GENERIC", 83},
    ...
    {"mlock2$GENERIC", 325},
    {"mlockall", 151},
    {"mlockall$GENERIC", 151},
    {"mmap", 9},
    {"mmap$GENERIC", 9},
    {"mmap$binder", 9},
    {"modify_ldt$GENERIC", 154},
    {"modify_ldt$read", 154},
    ...
    {"mount$GENERIC", 165},
    {"move_pages", 279},
    {"move_pages$GENERIC", 279},
    {"mprotect", 10},
    {"mprotect$GENERIC", 10},
    {"mq_getsetattr", 245},
    {"mq_getsetattr$GENERIC", 245},
    {"mq_notify", 244},
    {"mq_notify$GENERIC", 244},
    {"mq_open", 240},
    {"mq_open$GENERIC", 240},
    {"mq_timedreceive", 243},
    {"mq_timedreceive$GENERIC", 243},
    {"mq_timedsend", 242},
    {"mq_timedsend$GENERIC", 242},
    {"mq_unlink", 241},
    {"mq_unlink$GENERIC", 241},
    {"mremap", 25},
    {"mremap$GENERIC", 25},
    {"msgctl$GENERIC", 71},
    {"msgctl$IPC_INFO", 71},
    ...
    {"name_to_handle_at$GENERIC", 303},
    {"nanosleep", 35},
    {"nanosleep$GENERIC", 35},
    {"open", 2},
    {"open$GENERIC", 2},
    {"open$dir", 2},
    {"open_by_handle_at", 304},
    {"open_by_handle_at$GENERIC", 304},
    {"openat", 257},
    {"openat$GENERIC", 257},
    {"openat$ashmem", 257},
    {"openat$audio", 257},
    ...
    {"pause", 34},
    {"perf_event_open", 298},
    {"perf_event_open$GENERIC", 298},
    {"personality", 135},
    {"personality$GENERIC", 135},
    {"pipe", 22},
    {"pipe$GENERIC", 22},
    {"pipe2", 293},
    {"pipe2$GENERIC", 293},
    {"pivot_root", 155},
    {"pivot_root$GENERIC", 155},
    {"pkey_alloc", 330},
    {"pkey_alloc$GENERIC", 330},
    {"pkey_free", 331},
    {"pkey_free$GENERIC", 331},
    {"pkey_mprotect", 329},
    {"pkey_mprotect$GENERIC", 329},
    {"poll", 7},
    {"poll$GENERIC", 7},
    {"ppoll", 271},
    {"ppoll$GENERIC", 271},
    ...
    {"preadv$GENERIC", 295},
    {"prlimit64", 302},
    {"prlimit64$GENERIC", 302},
    {"process_vm_readv", 310},
    {"process_vm_readv$GENERIC", 310},
    {"process_vm_writev", 311},
    {"process_vm_writev$GENERIC", 311},
    {"pselect6", 270},
    {"pselect6$GENERIC", 270},
    {"ptrace", 101},
    {"ptrace$GENERIC", 101},
    ...
    {"pwritev$GENERIC", 296},
    {"quotactl", 179},
    {"quotactl$GENERIC", 179},
    {"read", 0},
    {"read$GENERIC", 0},
    {"read$eventfd", 0},
    {"readahead", 187},
    {"readahead$GENERIC", 187},
    {"readlink", 89},
    {"readlink$GENERIC", 89},
    {"readlinkat", 267},
    {"readlinkat$GENERIC", 267},
    {"readv", 19},
    {"readv$GENERIC", 19},
    {"recvfrom", 45},
    {"recvfrom$GENERIC", 45},
    ...
    {"recvfrom$unix", 45},
    {"recvmmsg", 299},
    {"recvmmsg$GENERIC", 299},
    {"recvmsg", 47},
    {"recvmsg$GENERIC", 47},
    {"recvmsg$kcm", 47},
    {"recvmsg$netrom", 47},
    {"remap_file_pages", 216},
    {"remap_file_pages$GENERIC", 216},
    {"removexattr", 197},
    {"removexattr$GENERIC", 197},
    {"rename", 82},
    {"rename$GENERIC", 82},
    {"renameat", 264},
    {"renameat$GENERIC", 264},
    {"renameat2", 316},
    {"renameat2$GENERIC", 316},
    {"request_key", 249},
    {"request_key$GENERIC", 249},
    {"restart_syscall", 219},
    {"rmdir", 84},
    {"rmdir$GENERIC", 84},
    {"rt_sigaction", 13},
    {"rt_sigaction$GENERIC", 13},
    {"rt_sigpending", 127},
    {"rt_sigpending$GENERIC", 127},
    {"rt_sigprocmask", 14},
    {"rt_sigprocmask$GENERIC", 14},
    {"rt_sigqueueinfo", 129},
    {"rt_sigqueueinfo$GENERIC", 129},
    {"rt_sigreturn", 15},
    {"rt_sigsuspend", 130},
    {"rt_sigsuspend$GENERIC", 130},
    {"rt_sigtimedwait", 128},
    {"rt_sigtimedwait$GENERIC", 128},
    {"rt_tgsigqueueinfo", 297},
    {"rt_tgsigqueueinfo$GENERIC", 297},
    {"sched_getaffinity", 204},
    {"sched_getaffinity$GENERIC", 204},
    {"sched_getattr", 315},
    {"sched_getattr$GENERIC", 315},
    {"sched_getparam", 143},
    {"sched_getparam$GENERIC", 143},
    {"sched_getscheduler", 145},
    {"sched_getscheduler$GENERIC", 145},
    {"sched_rr_get_interval", 148},
    {"sched_rr_get_interval$GENERIC", 148},
    {"sched_setaffinity", 203},
    {"sched_setaffinity$GENERIC", 203},
    {"sched_setattr", 314},
    {"sched_setattr$GENERIC", 314},
    {"sched_setparam", 142},
    {"sched_setparam$GENERIC", 142},
    {"sched_setscheduler", 144},
    {"sched_setscheduler$GENERIC", 144},
    {"sched_yield", 24},
    {"seccomp", 317},
    {"seccomp$GENERIC", 317},
    {"select", 23},
    ...
    {"semop$GENERIC", 65},
    {"semtimedop", 220},
    {"semtimedop$GENERIC", 220},
    {"sendfile", 40},
    {"sendfile$GENERIC", 40},
    {"sendmmsg", 307},
    {"sendmmsg$GENERIC", 307},
    {"sendmmsg$alg", 307},
    ...
    {"sendto$unix", 44},
    {"set_mempolicy", 238},
    {"set_mempolicy$GENERIC", 238},
    {"set_robust_list", 273},
    {"set_robust_list$GENERIC", 273},
    {"set_thread_area", 205},
    {"set_thread_area$GENERIC", 205},
    {"set_tid_address", 218},
    {"set_tid_address$GENERIC", 218},
    {"setfsgid", 123},
    {"setfsgid$GENERIC", 123},
    {"setfsuid", 122},
    {"setfsuid$GENERIC", 122},
    {"setgid", 106},
    {"setgid$GENERIC", 106},
    {"setgroups", 116},
    {"setgroups$GENERIC", 116},
    {"setitimer", 38},
    {"setitimer$GENERIC", 38},
    {"setns", 308},
    {"setns$GENERIC", 308},
    {"setpgid", 109},
    {"setpgid$GENERIC", 109},
    {"setpriority", 141},
    {"setpriority$GENERIC", 141},
    {"setregid", 114},
    {"setregid$GENERIC", 114},
    {"setresgid", 119},
    {"setresgid$GENERIC", 119},
    {"setresuid", 117},
    {"setresuid$GENERIC", 117},
    {"setreuid", 113},
    {"setreuid$GENERIC", 113},
    {"setrlimit", 160},
    {"setrlimit$GENERIC", 160},
    {"setsockopt", 54},
    ...
    {"shutdown$GENERIC", 48},
    {"sigaltstack", 131},
    {"sigaltstack$GENERIC", 131},
    {"signalfd", 282},
    {"signalfd$GENERIC", 282},
    {"signalfd4", 289},
    {"signalfd4$GENERIC", 289},
    {"socket", 41},
    {"socket$GENERIC", 41},
    {"socket$alg", 41},
    {"socket$ax25", 41},
    ...
    {"symlink$GENERIC", 88},
    {"symlinkat", 266},
    {"symlinkat$GENERIC", 266},
    {"sync", 162},
    {"sync_file_range", 277},
    {"sync_file_range$GENERIC", 277},
    {"syncfs", 306},
    {"syncfs$GENERIC", 306},
    {"sysfs$1", 139},
    {"sysfs$2", 139},
    ...
    {"time$GENERIC", 201},
    {"timer_create", 222},
    {"timer_create$GENERIC", 222},
    {"timer_delete", 226},
    {"timer_delete$GENERIC", 226},
    {"timer_getoverrun", 225},
    {"timer_getoverrun$GENERIC", 225},
    {"timer_gettime", 224},
    {"timer_gettime$GENERIC", 224},
    {"timer_settime", 223},
    {"timer_settime$GENERIC", 223},
    {"timerfd_create", 283},
    {"timerfd_create$GENERIC", 283},
    {"timerfd_gettime", 287},
    {"timerfd_gettime$GENERIC", 287},
    {"timerfd_settime", 286},
    {"timerfd_settime$GENERIC", 286},
    {"times", 100},
    {"times$GENERIC", 100},
    {"tkill", 200},
    {"tkill$GENERIC", 200},
    ...
    {"unlink$GENERIC", 87},
    {"unlinkat", 263},
    {"unlinkat$GENERIC", 263},
    {"unshare", 272},
    {"unshare$GENERIC", 272},
    {"uselib", 134},
    {"uselib$GENERIC", 134},
    {"userfaultfd", 323},
    {"userfaultfd$GENERIC", 323},
    {"ustat", 136},
    {"ustat$GENERIC", 136},
    {"utime", 132},
    {"utime$GENERIC", 132},
    {"utimensat", 280},
    {"utimensat$GENERIC", 280},
    {"utimes", 235},
    {"utimes$GENERIC", 235},
    {"vmsplice", 278},
    {"vmsplice$GENERIC", 278},
    {"wait4", 61},
    {"wait4$GENERIC", 61},
    {"waitid", 247},
    {"waitid$GENERIC", 247},
...
#define GOARCH "arm"
#define SYZ_REVISION "156ee64ef137d78aac5113253ac8a3837df97203"
#define SYZ_PAGE_SIZE 4096
#define SYZ_NUM_PAGES 4096
#define SYZ_DATA_OFFSET 536870912
unsigned syscall_count = 1869;
call_t syscalls[] = {
    {"accept", 285},
    {"accept$GENERIC", 285},
    {"accept$alg", 285},
    ...
    {"chroot$GENERIC", 61},
    {"clock_adjtime", 372},
    {"clock_adjtime$GENERIC", 372},
    {"clock_getres", 264},
    {"clock_getres$GENERIC", 264},
    {"clock_gettime", 263},
    {"clock_gettime$GENERIC", 263},
    {"clock_nanosleep", 265},
    {"clock_nanosleep$GENERIC", 265},
    {"clock_settime", 262},
    {"clock_settime$GENERIC", 262},
    {"clone", 120},
    {"clone$GENERIC", 120},
    {"close", 6},
    {"close$GENERIC", 6},
    ...
    {"dup3$GENERIC", 358},
    {"epoll_create", 250},
    {"epoll_create$GENERIC", 250},
    {"epoll_create1", 357},
    {"epoll_create1$GENERIC", 357},
    {"epoll_ctl$EPOLL_CTL_ADD", 251},
    {"epoll_ctl$EPOLL_CTL_DEL", 251},
    {"epoll_ctl$EPOLL_CTL_MOD", 251},
    {"epoll_ctl$GENERIC", 251},
    {"epoll_pwait", 346},
    {"epoll_pwait$GENERIC", 346},
    {"epoll_wait", 252},
    {"epoll_wait$GENERIC", 252},
    {"eventfd", 351},
    {"eventfd$GENERIC", 351},
    {"eventfd2", 356},
    {"eventfd2$GENERIC", 356},
    {"execve", 11},
    {"execve$GENERIC", 11},
    {"execveat", 387},
    {"execveat$GENERIC", 387},
    {"exit", 1},
    {"exit$GENERIC", 1},
    {"exit_group", 248},
    {"exit_group$GENERIC", 248},
    {"faccessat", 334},
    {"faccessat$GENERIC", 334},
    {"fallocate", 352},
    {"fallocate$GENERIC", 352},
    {"fanotify_init", 367},
    {"fanotify_init$GENERIC", 367},
    {"fanotify_mark", 368},
    {"fanotify_mark$GENERIC", 368},
    {"fchdir", 133},
    {"fchdir$GENERIC", 133},
    {"fchmod", 94},
    {"fchmod$GENERIC", 94},
    {"fchmodat", 333},
    {"fchmodat$GENERIC", 333},
    {"fchown", 95},
    {"fchown$GENERIC", 95},
    {"fchownat", 325},
    {"fchownat$GENERIC", 325},
    {"fcntl$F_GET_FILE_RW_HINT", 55},
    {"fcntl$F_GET_RW_HINT", 55},
    {"fcntl$F_SET_FILE_RW_HINT", 55},
    {"fcntl$F_SET_RW_HINT", 55},
    ...
    {"futex$GENERIC", 240},
    {"futimesat", 326},
    {"futimesat$GENERIC", 326},
    {"get_mempolicy", 320},
    {"get_mempolicy$GENERIC", 320},
    {"get_robust_list", 339},
    {"get_robust_list$GENERIC", 339},
    {"getcwd", 183},
    {"getcwd$GENERIC", 183},
    {"getdents", 141},
    {"getdents$GENERIC", 141},
    ...
    {"inotify_add_watch$GENERIC", 317},
    {"inotify_init", 316},
    {"inotify_init1", 360},
    {"inotify_init1$GENERIC", 360},
    {"inotify_rm_watch", 318},
    {"inotify_rm_watch$GENERIC", 318},
    {"io_cancel", 247},
    {"io_cancel$GENERIC", 247},
    {"io_destroy", 244},
    {"io_destroy$GENERIC", 244},
    {"io_getevents", 245},
    {"io_getevents$GENERIC", 245},
    {"io_setup", 243},
    {"io_setup$GENERIC", 243},
    {"io_submit", 246},
    {"io_submit$GENERIC", 246},
    {"ioctl", 54},
    {"ioctl$ASHMEM_GET_NAME", 54},
    {"ioctl$ASHMEM_GET_PIN_STATUS", 54},
    {"ioctl$ASHMEM_GET_PROT_MASK", 54},
    ...
    {"ioctl$sock_proto_private", 54},
    {"ioctl$void", 54},
    {"ioprio_get$GENERIC", 315},
    {"ioprio_get$pid", 315},
    {"ioprio_get$uid", 315},
    {"ioprio_set$GENERIC", 314},
    {"ioprio_set$pid", 314},
    {"ioprio_set$uid", 314},
    {"kcmp", 378},
    {"kcmp$GENERIC", 378},
    ...
    {"mbind$GENERIC", 319},
    {"membarrier", 389},
    {"membarrier$GENERIC", 389},
    {"memfd_create", 385},
    {"memfd_create$GENERIC", 385},
    {"mincore", 219},
    {"mincore$GENERIC", 219},
    {"mkdir", 39},
    {"mkdir$GENERIC", 39},
    ...
    {"mount$GENERIC", 21},
    {"move_pages", 344},
    {"move_pages$GENERIC", 344},
    {"mprotect", 125},
    {"mprotect$GENERIC", 125},
    {"mq_getsetattr", 279},
    {"mq_getsetattr$GENERIC", 279},
    {"mq_notify", 278},
    {"mq_notify$GENERIC", 278},
    {"mq_open", 274},
    {"mq_open$GENERIC", 274},
    {"mq_timedreceive", 277},
    {"mq_timedreceive$GENERIC", 277},
    {"mq_timedsend", 276},
    {"mq_timedsend$GENERIC", 276},
    {"mq_unlink", 275},
    {"mq_unlink$GENERIC", 275},
    {"mremap", 163},
    {"mremap$GENERIC", 163},
    {"msgctl$GENERIC", 304},
    {"msgctl$IPC_INFO", 304},
    ...
    {"pipe2$GENERIC", 359},
    {"pivot_root", 218},
    {"pivot_root$GENERIC", 218},
    {"pkey_alloc", 395},
    {"pkey_alloc$GENERIC", 395},
    {"pkey_free", 396},
    {"pkey_free$GENERIC", 396},
    {"pkey_mprotect", 394},
    {"pkey_mprotect$GENERIC", 394},
    {"poll", 168},
    {"poll$GENERIC", 168},
    {"ppoll", 336},
    {"ppoll$GENERIC", 336},
    ...
    {"preadv$GENERIC", 361},
    {"prlimit64", 369},
    {"prlimit64$GENERIC", 369},
    {"process_vm_readv", 376},
    {"process_vm_readv$GENERIC", 376},
    {"process_vm_writev", 377},
    {"process_vm_writev$GENERIC", 377},
    {"pselect6", 335},
    {"pselect6$GENERIC", 335},
    {"ptrace", 26},
    {"ptrace$GENERIC", 26},
    {"ptrace$PTRACE_SECCOMP_GET_FILTER", 26},
    {"ptrace$PTRACE_SECCOMP_GET_METADATA", 26},
    ...
    {"readlink$GENERIC", 85},
    {"readlinkat", 332},
    {"readlinkat$GENERIC", 332},
    {"readv", 145},
    {"readv$GENERIC", 145},
    {"recvfrom", 292},
    {"recvfrom$GENERIC", 292},
    {"recvfrom$ax25", 292},
    {"recvfrom$inet", 292},
    {"recvfrom$inet6", 292},
    {"recvfrom$ipx", 292},
    ...
    {"recvfrom$unix", 292},
    {"recvmmsg", 365},
    {"recvmmsg$GENERIC", 365},
    {"recvmsg", 297},
    {"recvmsg$GENERIC", 297},
    {"recvmsg$kcm", 297},
    {"recvmsg$netrom", 297},
    {"remap_file_pages", 253},
    {"remap_file_pages$GENERIC", 253},
    {"removexattr", 235},
    {"removexattr$GENERIC", 235},
    {"rename", 38},
    {"rename$GENERIC", 38},
    {"renameat", 329},
    {"renameat$GENERIC", 329},
    {"renameat2", 382},
    {"renameat2$GENERIC", 382},
    {"request_key", 310},
    {"request_key$GENERIC", 310},
    {"restart_syscall", 0},
    {"rmdir", 40},
    {"rmdir$GENERIC", 40},
    {"rt_sigaction", 174},
    ...
    {"rt_tgsigqueueinfo$GENERIC", 363},
    {"sched_getaffinity", 242},
    {"sched_getaffinity$GENERIC", 242},
    {"sched_getattr", 381},
    {"sched_getattr$GENERIC", 381},
    {"sched_getparam", 155},
    {"sched_getparam$GENERIC", 155},
    {"sched_getscheduler", 157},
    {"sched_getscheduler$GENERIC", 157},
    ...
    {"semop$GENERIC", 298},
    {"semtimedop", 312},
    {"semtimedop$GENERIC", 312},
    {"sendfile", 187},
    {"sendfile$GENERIC", 187},
    {"sendfile64", 239},
    {"sendfile64$GENERIC", 239},
    {"sendmmsg", 374},
    {"sendmmsg$GENERIC", 374},
    {"sendmmsg$alg", 374},
    ...
    {"sendto$unix", 290},
    {"set_mempolicy", 321},
    {"set_mempolicy$GENERIC", 321},
    {"set_robust_list", 338},
    {"set_robust_list$GENERIC", 338},
    {"set_tid_address", 256},
    {"set_tid_address$GENERIC", 256},
    {"setfsgid", 139},
    {"setfsgid$GENERIC", 139},
    {"setfsuid", 138},
    {"setfsuid$GENERIC", 138},
    ...
    {"shmget$private", 307},
    {"shutdown", 293},
    {"shutdown$GENERIC", 293},
    {"sigaltstack", 186},
    {"sigaltstack$GENERIC", 186},
    {"signalfd", 349},
    {"signalfd$GENERIC", 349},
    {"signalfd4", 355},
    {"signalfd4$GENERIC", 355},
    {"socket", 281},
    {"socket$GENERIC", 281},
    {"socket$alg", 281},
    {"socket$ax25", 281},
    ...
    {"tgkill$GENERIC", 268},
    {"timer_create", 257},
    {"timer_create$GENERIC", 257},
    {"timer_delete", 261},
    {"timer_delete$GENERIC", 261},
    {"timer_getoverrun", 260},
    {"timer_getoverrun$GENERIC", 260},
    {"timer_gettime", 259},
    {"timer_gettime$GENERIC", 259},
    {"timer_settime", 258},
    {"timer_settime$GENERIC", 258},
    {"timerfd_create", 350},
    {"timerfd_create$GENERIC", 350},
    {"timerfd_gettime", 354},
    {"timerfd_gettime$GENERIC", 354},
    {"timerfd_settime", 353},
    {"timerfd_settime$GENERIC", 353},
    {"times", 43},
    {"times$GENERIC", 43},
    {"tkill", 238},
    {"tkill$GENERIC", 238},
    ...
    {"unlink$GENERIC", 10},
    {"unlinkat", 328},
    {"unlinkat$GENERIC", 328},
    {"unshare", 337},
    {"unshare$GENERIC", 337},
    {"uselib", 86},
    {"uselib$GENERIC", 86},
    {"userfaultfd", 388},
    {"userfaultfd$GENERIC", 388},
    {"ustat", 62},
    {"ustat$GENERIC", 62},
    {"utimensat", 348},
    {"utimensat$GENERIC", 348},
    {"utimes", 269},
    {"utimes$GENERIC", 269},
    {"vmsplice", 343},
    {"vmsplice$GENERIC", 343},
    {"wait4", 114},
    {"wait4$GENERIC", 114},
    {"waitid", 280},
    {"waitid$GENERIC", 280},
...
#define GOARCH "arm64"
#define SYZ_REVISION "2527508928004320da4433812a99b8dffd345911"
#define SYZ_PAGE_SIZE 4096
#define SYZ_NUM_PAGES 4096
#define SYZ_DATA_OFFSET 536870912
unsigned syscall_count = 1817;
call_t syscalls[] = {
    {"accept", 202},
    {"accept$GENERIC", 202},
    {"accept$alg", 202},
    ...
    {"chroot$GENERIC", 51},
    {"clock_adjtime", 266},
    {"clock_adjtime$GENERIC", 266},
    {"clock_getres", 114},
    {"clock_getres$GENERIC", 114},
    {"clock_gettime", 113},
    {"clock_gettime$GENERIC", 113},
    {"clock_nanosleep", 115},
    {"clock_nanosleep$GENERIC", 115},
    {"clock_settime", 112},
    {"clock_settime$GENERIC", 112},
    {"clone", 220},
    {"clone$GENERIC", 220},
    {"close", 57},
    {"close$GENERIC", 57},
    ...
    {"delete_module", 106},
    {"delete_module$GENERIC", 106},
    {"dup", 23},
    {"dup$GENERIC", 23},
    {"dup3", 24},
    {"dup3$GENERIC", 24},
    {"epoll_create1", 20},
    {"epoll_create1$GENERIC", 20},
    {"epoll_ctl$EPOLL_CTL_ADD", 21},
    {"epoll_ctl$EPOLL_CTL_DEL", 21},
    {"epoll_ctl$EPOLL_CTL_MOD", 21},
    {"epoll_ctl$GENERIC", 21},
    {"epoll_pwait", 22},
    {"epoll_pwait$GENERIC", 22},
    {"eventfd2", 19},
    {"eventfd2$GENERIC", 19},
    {"execve", 221},
    {"execve$GENERIC", 221},
    {"execveat", 281},
    {"execveat$GENERIC", 281},
    {"exit", 93},
    {"exit$GENERIC", 93},
    {"exit_group", 94},
    {"exit_group$GENERIC", 94},
    {"faccessat", 48},
    {"faccessat$GENERIC", 48},
    {"fadvise64", 223},
    {"fadvise64$GENERIC", 223},
    {"fallocate", 47},
    {"fallocate$GENERIC", 47},
    {"fanotify_init", 262},
    {"fanotify_init$GENERIC", 262},
    {"fanotify_mark", 263},
    {"fanotify_mark$GENERIC", 263},
    {"fchdir", 50},
    {"fchdir$GENERIC", 50},
    {"fchmod", 52},
    {"fchmod$GENERIC", 52},
    ...
    {"fcntl$setstatus", 25},
    {"fdatasync", 83},
    {"fdatasync$GENERIC", 83},
    {"fgetxattr", 10},
    {"fgetxattr$GENERIC", 10},
    {"finit_module", 273},
    {"finit_module$GENERIC", 273},
    {"flistxattr", 13},
    {"flistxattr$GENERIC", 13},
    {"flock", 32},
    {"flock$GENERIC", 32},
    {"fremovexattr", 16},
    {"fremovexattr$GENERIC", 16},
    {"fsetxattr", 7},
    {"fsetxattr$GENERIC", 7},
    {"fstat", 80},
    {"fstat$GENERIC", 80},
    ...
    {"fsync$GENERIC", 82},
    {"ftruncate", 46},
    {"ftruncate$GENERIC", 46},
    {"futex", 98},
    {"futex$GENERIC", 98},
    {"get_mempolicy", 236},
    {"get_mempolicy$GENERIC", 236},
    {"get_robust_list", 100},
    {"get_robust_list$GENERIC", 100},
    {"getcwd", 17},
    {"getcwd$GENERIC", 17},
    {"getdents64", 61},
    {"getdents64$GENERIC", 61},
    {"getegid", 177},
    {"geteuid", 175},
    {"getgid", 176},
    {"getgroups", 158},
    {"getgroups$GENERIC", 158},
    {"getitimer", 102},
    {"getitimer$GENERIC", 102},
    {"getpeername", 205},
    {"getpeername$GENERIC", 205},
    ...
    {"getpid", 172},
    {"getpriority", 141},
    {"getpriority$GENERIC", 141},
    {"getrandom", 278},
    {"getrandom$GENERIC", 278},
    {"getresgid", 150},
    {"getresgid$GENERIC", 150},
    {"getresuid", 148},
    {"getresuid$GENERIC", 148},
    {"getrlimit", 163},
    {"getrlimit$GENERIC", 163},
    {"getrusage", 165},
    {"getrusage$GENERIC", 165},
    {"getsockname", 204},
    {"getsockname$GENERIC", 204},
    ...
    {"getxattr$GENERIC", 8},
    {"init_module", 105},
    {"init_module$GENERIC", 105},
    {"inotify_add_watch", 27},
    {"inotify_add_watch$GENERIC", 27},
    {"inotify_init1", 26},
    {"inotify_init1$GENERIC", 26},
    {"inotify_rm_watch", 28},
    {"inotify_rm_watch$GENERIC", 28},
    {"io_cancel", 3},
    {"io_cancel$GENERIC", 3},
    {"io_destroy", 1},
    {"io_destroy$GENERIC", 1},
    {"io_getevents", 4},
    {"io_getevents$GENERIC", 4},
    {"io_setup", 0},
    {"io_setup$GENERIC", 0},
    {"io_submit", 2},
    {"io_submit$GENERIC", 2},
    ...
    {"ioctl$void", 29},
    {"ioprio_get$GENERIC", 31},
    {"ioprio_get$pid", 31},
    {"ioprio_get$uid", 31},
    {"ioprio_set$GENERIC", 30},
    {"ioprio_set$pid", 30},
    {"ioprio_set$uid", 30},
    {"kcmp", 272},
    {"kcmp$GENERIC", 272},
    ...
    {"listen$netrom", 201},
    {"listxattr", 11},
    {"listxattr$GENERIC", 11},
    {"llistxattr", 12},
    {"llistxattr$GENERIC", 12},
    {"lookup_dcookie", 18},
    {"lookup_dcookie$GENERIC", 18},
    {"lremovexattr", 15},
    {"lremovexattr$GENERIC", 15},
    {"lseek", 62},
    {"lseek$GENERIC", 62},
    {"lsetxattr", 6},
    {"lsetxattr$GENERIC", 6},
    ...
    {"mbind$GENERIC", 235},
    {"membarrier", 283},
    {"membarrier$GENERIC", 283},
    {"memfd_create", 279},
    {"memfd_create$GENERIC", 279},
    {"migrate_pages", 238},
    {"migrate_pages$GENERIC", 238},
    {"mincore", 232},
    {"mincore$GENERIC", 232},
    {"mkdirat", 34},
    {"mkdirat$GENERIC", 34},
    ...
    {"mount$GENERIC", 40},
    {"move_pages", 239},
    {"move_pages$GENERIC", 239},
    {"mprotect", 226},
    {"mprotect$GENERIC", 226},
    {"mq_getsetattr", 185},
    {"mq_getsetattr$GENERIC", 185},
    {"mq_notify", 184},
    {"mq_notify$GENERIC", 184},
    {"mq_open", 180},
    {"mq_open$GENERIC", 180},
    {"mq_timedreceive", 183},
    {"mq_timedreceive$GENERIC", 183},
    {"mq_timedsend", 182},
    {"mq_timedsend$GENERIC", 182},
    {"mq_unlink", 181},
    {"mq_unlink$GENERIC", 181},
    {"mremap", 216},
    {"mremap$GENERIC", 216},
    {"msgctl$GENERIC", 187},
    {"msgctl$IPC_INFO", 187},
    ...
    {"name_to_handle_at$GENERIC", 264},
    {"nanosleep", 101},
    {"nanosleep$GENERIC", 101},
    {"open_by_handle_at", 265},
    {"open_by_handle_at$GENERIC", 265},
    {"openat", 56},
    {"openat$GENERIC", 56},
    {"openat$ashmem", 56},
    {"openat$audio", 56},
    ...
    {"openat$zygote", 56},
    {"perf_event_open", 241},
    {"perf_event_open$GENERIC", 241},
    {"personality", 92},
    {"personality$GENERIC", 92},
    {"pipe2", 59},
    {"pipe2$GENERIC", 59},
    {"pivot_root", 41},
    {"pivot_root$GENERIC", 41},
    {"pkey_alloc", 289},
    {"pkey_alloc$GENERIC", 289},
    {"pkey_free", 290},
    {"pkey_free$GENERIC", 290},
    {"pkey_mprotect", 288},
    {"pkey_mprotect$GENERIC", 288},
    {"ppoll", 73},
    {"ppoll$GENERIC", 73},
    {"prctl$GENERIC", 167},
    {"prctl$getname", 167},
    ...
    {"preadv$GENERIC", 69},
    {"prlimit64", 261},
    {"prlimit64$GENERIC", 261},
    {"process_vm_readv", 270},
    {"process_vm_readv$GENERIC", 270},
    {"process_vm_writev", 271},
    {"process_vm_writev$GENERIC", 271},
    {"pselect6", 72},
    {"pselect6$GENERIC", 72},
    {"ptrace", 117},
    {"ptrace$GENERIC", 117},
    ...
    {"read$eventfd", 63},
    {"readahead", 213},
    {"readahead$GENERIC", 213},
    {"readlinkat", 78},
    {"readlinkat$GENERIC", 78},
    {"readv", 65},
    {"readv$GENERIC", 65},
    {"recvfrom", 207},
    {"recvfrom$GENERIC", 207},
    {"recvfrom$ax25", 207},
    {"recvfrom$inet", 207},
    {"recvfrom$inet6", 207},
    {"recvfrom$ipx", 207},
    ...
    {"recvfrom$unix", 207},
    {"recvmmsg", 243},
    {"recvmmsg$GENERIC", 243},
    {"recvmsg", 212},
    {"recvmsg$GENERIC", 212},
    {"recvmsg$kcm", 212},
    {"recvmsg$netrom", 212},
    {"remap_file_pages", 234},
    {"remap_file_pages$GENERIC", 234},
    {"removexattr", 14},
    {"removexattr$GENERIC", 14},
    {"renameat", 38},
    {"renameat$GENERIC", 38},
    {"renameat2", 276},
    {"renameat2$GENERIC", 276},
    {"request_key", 218},
    {"request_key$GENERIC", 218},
    {"restart_syscall", 128},
    {"rt_sigaction", 134},
    {"rt_sigaction$GENERIC", 134},
    {"rt_sigpending", 136},
    {"rt_sigpending$GENERIC", 136},
    {"rt_sigprocmask", 135},
    {"rt_sigprocmask$GENERIC", 135},
    {"rt_sigqueueinfo", 138},
    {"rt_sigqueueinfo$GENERIC", 138},
    {"rt_sigreturn", 139},
    {"rt_sigsuspend", 133},
    {"rt_sigsuspend$GENERIC", 133},
    {"rt_sigtimedwait", 137},
    {"rt_sigtimedwait$GENERIC", 137},
    {"rt_tgsigqueueinfo", 240},
    {"rt_tgsigqueueinfo$GENERIC", 240},
    {"sched_getaffinity", 123},
    {"sched_getaffinity$GENERIC", 123},
    {"sched_getattr", 275},
    {"sched_getattr$GENERIC", 275},
    {"sched_getparam", 121},
    {"sched_getparam$GENERIC", 121},
    {"sched_getscheduler", 120},
    {"sched_getscheduler$GENERIC", 120},
    {"sched_rr_get_interval", 127},
    {"sched_rr_get_interval$GENERIC", 127},
    {"sched_setaffinity", 122},
    {"sched_setaffinity$GENERIC", 122},
    {"sched_setattr", 274},
    {"sched_setattr$GENERIC", 274},
    {"sched_setparam", 118},
    {"sched_setparam$GENERIC", 118},
    {"sched_setscheduler", 119},
    {"sched_setscheduler$GENERIC", 119},
    {"sched_yield", 124},
    {"seccomp", 277},
    {"seccomp$GENERIC", 277},
    {"semctl$GENERIC", 191},
    ...
    {"semop$GENERIC", 193},
    {"semtimedop", 192},
    {"semtimedop$GENERIC", 192},
    {"sendfile", 71},
    {"sendfile$GENERIC", 71},
    {"sendmmsg", 269},
    {"sendmmsg$GENERIC", 269},
    {"sendmmsg$alg", 269},
    ...
    {"sendto$unix", 206},
    {"set_mempolicy", 237},
    {"set_mempolicy$GENERIC", 237},
    {"set_robust_list", 99},
    {"set_robust_list$GENERIC", 99},
    {"set_tid_address", 96},
    {"set_tid_address$GENERIC", 96},
    {"setfsgid", 152},
    {"setfsgid$GENERIC", 152},
    {"setfsuid", 151},
    {"setfsuid$GENERIC", 151},
    {"setgid", 144},
    {"setgid$GENERIC", 144},
    {"setgroups", 159},
    {"setgroups$GENERIC", 159},
    {"setitimer", 103},
    {"setitimer$GENERIC", 103},
    {"setns", 268},
    {"setns$GENERIC", 268},
    {"setpgid", 154},
    {"setpgid$GENERIC", 154},
    {"setpriority", 140},
    {"setpriority$GENERIC", 140},
    {"setregid", 143},
    {"setregid$GENERIC", 143},
    {"setresgid", 149},
    {"setresgid$GENERIC", 149},
    {"setresuid", 147},
    {"setresuid$GENERIC", 147},
    {"setreuid", 145},
    {"setreuid$GENERIC", 145},
    {"setrlimit", 164},
    {"setrlimit$GENERIC", 164},
    {"setsockopt", 208},
    ...
    {"shmget$private", 194},
    {"shutdown", 210},
    {"shutdown$GENERIC", 210},
    {"sigaltstack", 132},
    {"sigaltstack$GENERIC", 132},
    {"signalfd4", 74},
    {"signalfd4$GENERIC", 74},
    {"socket", 198},
    {"socket$GENERIC", 198},
    {"socket$alg", 198},
    {"socket$ax25", 198},
    ...
    {"statx$GENERIC", 291},
    {"symlinkat", 36},
    {"symlinkat$GENERIC", 36},
    {"sync", 81},
    {"sync_file_range", 84},
    {"sync_file_range$GENERIC", 84},
    {"syncfs", 267},
    {"syncfs$GENERIC", 267},
    {"sysinfo", 179},
    {"sysinfo$GENERIC", 179},
    ...
    {"tgkill$GENERIC", 131},
    {"timer_create", 107},
    {"timer_create$GENERIC", 107},
    {"timer_delete", 111},
    {"timer_delete$GENERIC", 111},
    {"timer_getoverrun", 109},
    {"timer_getoverrun$GENERIC", 109},
    {"timer_gettime", 108},
    {"timer_gettime$GENERIC", 108},
    {"timer_settime", 110},
    {"timer_settime$GENERIC", 110},
    {"timerfd_create", 85},
    {"timerfd_create$GENERIC", 85},
    {"timerfd_gettime", 87},
    {"timerfd_gettime$GENERIC", 87},
    {"timerfd_settime", 86},
    {"timerfd_settime$GENERIC", 86},
    {"times", 153},
    {"times$GENERIC", 153},
    {"tkill", 130},
    {"tkill$GENERIC", 130},
    ...
    {"unshare$GENERIC", 97},
    {"userfaultfd", 282},
    {"userfaultfd$GENERIC", 282},
    {"utimensat", 88},
    {"utimensat$GENERIC", 88},
    {"vmsplice", 75},
    {"vmsplice$GENERIC", 75},
    {"wait4", 260},
    {"wait4$GENERIC", 260},
...
#define SYZ_REVISION "36e75fdf9f94e5e8b097ae87e9098b8670d7d069"
#define SYZ_PAGE_SIZE 4096
#define SYZ_NUM_PAGES 4096
#define SYZ_DATA_OFFSET 536870912
...
call_t syscalls[] = {
    ...
    {"chroot$GENERIC", 61},
    {"clock_adjtime", 347},
    {"clock_adjtime$GENERIC", 347},
    {"clock_getres", 247},
    {"clock_getres$GENERIC", 247},
    {"clock_gettime", 246},
    {"clock_gettime$GENERIC", 246},
    {"clock_nanosleep", 248},
    {"clock_nanosleep$GENERIC", 248},
    {"clock_settime", 245},
    {"clock_settime$GENERIC", 245},
    {"clone", 120},
    {"clone$GENERIC", 120},
    {"close", 6},
    {"close$GENERIC", 6},
    ...
    {"dup3$GENERIC", 316},
    {"epoll_create", 236},
    {"epoll_create$GENERIC", 236},
    {"epoll_create1", 315},
    {"epoll_create1$GENERIC", 315},
    {"epoll_ctl$EPOLL_CTL_ADD", 237},
    {"epoll_ctl$EPOLL_CTL_DEL", 237},
    {"epoll_ctl$EPOLL_CTL_MOD", 237},
    {"epoll_ctl$GENERIC", 237},
    {"epoll_pwait", 303},
    {"epoll_pwait$GENERIC", 303},
    {"epoll_wait", 238},
    {"epoll_wait$GENERIC", 238},
    {"eventfd", 307},
    {"eventfd$GENERIC", 307},
    {"eventfd2", 314},
    {"eventfd2$GENERIC", 314},
    {"execve", 11},
    {"execve$GENERIC", 11},
    {"execveat", 362},
    {"execveat$GENERIC", 362},
    {"exit", 1},
    {"exit$GENERIC", 1},
    {"exit_group", 234},
    {"exit_group$GENERIC", 234},
    {"faccessat", 298},
    {"faccessat$GENERIC", 298},
    {"fadvise64", 233},
    {"fadvise64$GENERIC", 233},
    {"fallocate", 309},
    {"fallocate$GENERIC", 309},
    {"fanotify_init", 323},
    {"fanotify_init$GENERIC", 323},
    {"fanotify_mark", 324},
    {"fanotify_mark$GENERIC", 324},
    {"fchdir", 133},
    {"fchdir$GENERIC", 133},
    {"fchmod", 94},
    {"fchmod$GENERIC", 94},
    {"fchmodat", 297},
    {"fchmodat$GENERIC", 297},
    {"fchown", 95},
    {"fchown$GENERIC", 95},
    {"fchownat", 289},
    {"fchownat$GENERIC", 289},
    {"fcntl$F_GET_FILE_RW_HINT", 55},
    {"fcntl$F_GET_RW_HINT", 55},
    {"fcntl$F_SET_FILE_RW_HINT", 55},
    {"fcntl$F_SET_RW_HINT", 55},
    ...
    {"fdatasync$GENERIC", 148},
    {"fgetxattr", 214},
    {"fgetxattr$GENERIC", 214},
    {"finit_module", 353},
    {"finit_module$GENERIC", 353},
    {"flistxattr", 217},
    {"flistxattr$GENERIC", 217},
    {"flock", 143},
    {"flock$GENERIC", 143},
    {"fremovexattr", 220},
    {"fremovexattr$GENERIC", 220},
    {"fsetxattr", 211},
    {"fsetxattr$GENERIC", 211},
    {"fstat", 108},
    {"fstat$GENERIC", 108},
    {"fstatfs", 100},
    {"fstatfs$GENERIC", 100},
    ...
    {"futex$GENERIC", 221},
    {"futimesat", 290},
    {"futimesat$GENERIC", 290},
    {"get_mempolicy", 260},
    {"get_mempolicy$GENERIC", 260},
    {"get_robust_list", 299},
    {"get_robust_list$GENERIC", 299},
    {"getcwd", 182},
    {"getcwd$GENERIC", 182},
    {"getdents", 141},
    {"getdents$GENERIC", 141},
    {"getdents64", 202},
    {"getdents64$GENERIC", 202},
    {"getegid", 50},
    {"geteuid", 49},
    {"getgid", 47},
    {"getgroups", 80},
    ...
    {"getpriority$GENERIC", 96},
    {"getrandom", 359},
    {"getrandom$GENERIC", 359},
    {"getresgid", 170},
    {"getresgid$GENERIC", 170},
    {"getresuid", 165},
    {"getresuid$GENERIC", 165},
    {"getrlimit", 76},
    {"getrlimit$GENERIC", 76},
    ...
    {"getuid", 24},
    {"getxattr", 212},
    {"getxattr$GENERIC", 212},
    {"init_module", 128},
    {"init_module$GENERIC", 128},
    {"inotify_add_watch", 276},
    {"inotify_add_watch$GENERIC", 276},
    {"inotify_init", 275},
    {"inotify_init1", 318},
    {"inotify_init1$GENERIC", 318},
    {"inotify_rm_watch", 277},
    {"inotify_rm_watch$GENERIC", 277},
    {"io_cancel", 231},
    {"io_cancel$GENERIC", 231},
    {"io_destroy", 228},
    {"io_destroy$GENERIC", 228},
    {"io_getevents", 229},
    {"io_getevents$GENERIC", 229},
    {"io_setup", 227},
    {"io_setup$GENERIC", 227},
    {"io_submit", 230},
    {"io_submit$GENERIC", 230},
    {"ioctl", 54},
    {"ioctl$ASHMEM_GET_NAME", 54},
    {"ioctl$ASHMEM_GET_PIN_STATUS", 54},
    {"ioctl$ASHMEM_GET_PROT_MASK", 54},
    ...
    {"iopl", 110},
    {"iopl$GENERIC", 110},
    {"ioprio_get$GENERIC", 274},
    {"ioprio_get$pid", 274},
    {"ioprio_get$uid", 274},
    {"ioprio_set$GENERIC", 273},
    {"ioprio_set$pid", 273},
    {"ioprio_set$uid", 273},
    {"kcmp", 354},
    {"kcmp$GENERIC", 354},
    ...
    {"listen$netrom", 329},
    {"listxattr", 215},
    {"listxattr$GENERIC", 215},
    {"llistxattr", 216},
    {"llistxattr$GENERIC", 216},
    {"lookup_dcookie", 235},
    {"lookup_dcookie$GENERIC", 235},
    {"lremovexattr", 219},
    {"lremovexattr$GENERIC", 219},
    {"lseek", 19},
    {"lseek$GENERIC", 19},
    {"lsetxattr", 210},
    {"lsetxattr$GENERIC", 210},
    {"lstat", 107},
    {"lstat$GENERIC", 107},
    {"madvise", 205},
    {"madvise$GENERIC", 205},
    ...
    {"mbind$GENERIC", 259},
    {"membarrier", 365},
    {"membarrier$GENERIC", 365},
    {"memfd_create", 360},
    {"memfd_create$GENERIC", 360},
    {"migrate_pages", 258},
    {"migrate_pages$GENERIC", 258},
    {"mincore", 206},
    {"mincore$GENERIC", 206},
    {"mkdir", 39},
    {"mkdir$GENERIC", 39},
    ...
    {"mount$GENERIC", 21},
    {"move_pages", 301},
    {"move_pages$GENERIC", 301},
    {"mprotect", 125},
    {"mprotect$GENERIC", 125},
    {"mq_getsetattr", 267},
    {"mq_getsetattr$GENERIC", 267},
    {"mq_notify", 266},
    {"mq_notify$GENERIC", 266},
    {"mq_open", 262},
    {"mq_open$GENERIC", 262},
    {"mq_timedreceive", 265},
    {"mq_timedreceive$GENERIC", 265},
    {"mq_timedsend", 264},
    {"mq_timedsend$GENERIC", 264},
    {"mq_unlink", 263},
    {"mq_unlink$GENERIC", 263},
    {"mremap", 163},
    {"mremap$GENERIC", 163},
    {"msync", 144},
    {"msync$GENERIC", 144},
    ...
    {"pipe2$GENERIC", 317},
    {"pivot_root", 203},
    {"pivot_root$GENERIC", 203},
    {"pkey_alloc", 384},
    {"pkey_alloc$GENERIC", 384},
    {"pkey_free", 385},
    {"pkey_free$GENERIC", 385},
    {"pkey_mprotect", 386},
    {"pkey_mprotect$GENERIC", 386},
    {"poll", 167},
    {"poll$GENERIC", 167},
    {"ppoll", 281},
    {"ppoll$GENERIC", 281},
    ...
    {"preadv$GENERIC", 320},
    {"prlimit64", 325},
    {"prlimit64$GENERIC", 325},
    {"process_vm_readv", 351},
    {"process_vm_readv$GENERIC", 351},
    {"process_vm_writev", 352},
    {"process_vm_writev$GENERIC", 352},
    {"pselect6", 280},
    {"pselect6$GENERIC", 280},
    {"ptrace", 26},
    {"ptrace$GENERIC", 26},
    {"ptrace$PTRACE_SECCOMP_GET_FILTER", 26},
    {"ptrace$PTRACE_SECCOMP_GET_METADATA", 26},
    ...
    {"read$eventfd", 3},
    {"readahead", 191},
    {"readahead$GENERIC", 191},
    {"readlink", 85},
    {"readlink$GENERIC", 85},
    {"readlinkat", 296},
    {"readlinkat$GENERIC", 296},
    {"readv", 145},
    {"readv$GENERIC", 145},
    {"recvfrom", 337},
    {"recvfrom$GENERIC", 337},
    {"recvfrom$ax25", 337},
    {"recvfrom$inet", 337},
    {"recvfrom$inet6", 337},
    {"recvfrom$ipx", 337},
    ...
    {"recvfrom$unix", 337},
    {"recvmmsg", 343},
    {"recvmmsg$GENERIC", 343},
    {"recvmsg", 342},
    {"recvmsg$GENERIC", 342},
    {"recvmsg$kcm", 342},
    {"recvmsg$netrom", 342},
    {"remap_file_pages", 239},
    {"remap_file_pages$GENERIC", 239},
    {"removexattr", 218},
    {"removexattr$GENERIC", 218},
    {"rename", 38},
    {"rename$GENERIC", 38},
    {"renameat", 293},
    {"renameat$GENERIC", 293},
    {"renameat2", 357},
    {"renameat2$GENERIC", 357},
    {"request_key", 270},
    {"request_key$GENERIC", 270},
    {"restart_syscall", 0},
    {"rmdir", 40},
    {"rmdir$GENERIC", 40},
    {"rt_sigaction", 173},
    {"rt_sigaction$GENERIC", 173},
    {"rt_sigpending", 175},
    {"rt_sigpending$GENERIC", 175},
    {"rt_sigprocmask", 174},
    {"rt_sigprocmask$GENERIC", 174},
    {"rt_sigqueueinfo", 177},
    {"rt_sigqueueinfo$GENERIC", 177},
    {"rt_sigreturn", 172},
    {"rt_sigsuspend", 178},
    {"rt_sigsuspend$GENERIC", 178},
    {"rt_sigtimedwait", 176},
    {"rt_sigtimedwait$GENERIC", 176},
    {"rt_tgsigqueueinfo", 322},
    {"rt_tgsigqueueinfo$GENERIC", 322},
    {"sched_getaffinity", 223},
    {"sched_getaffinity$GENERIC", 223},
    {"sched_getattr", 356},
    {"sched_getattr$GENERIC", 356},
    {"sched_getparam", 155},
    {"sched_getparam$GENERIC", 155},
    {"sched_getscheduler", 157},
    {"sched_getscheduler$GENERIC", 157},
    ...
    {"sched_setaffinity$GENERIC", 222},
    {"sched_setattr", 355},
    {"sched_setattr$GENERIC", 355},
    {"sched_setparam", 154},
    {"sched_setparam$GENERIC", 154},
    {"sched_setscheduler", 156},
    {"sched_setscheduler$GENERIC", 156},
    ...
    {"select$GENERIC", 82},
    {"sendfile", 186},
    {"sendfile$GENERIC", 186},
    {"sendmmsg", 349},
    {"sendmmsg$GENERIC", 349},
    {"sendmmsg$alg", 349},
    ...
    {"sendto$unix", 335},
    {"set_mempolicy", 261},
    {"set_mempolicy$GENERIC", 261},
    {"set_robust_list", 300},
    {"set_robust_list$GENERIC", 300},
    {"set_tid_address", 232},
    {"set_tid_address$GENERIC", 232},
    {"setfsgid", 139},
    {"setfsgid$GENERIC", 139},
    {"setfsuid", 138},
    {"setfsuid$GENERIC", 138},
    ...
    {"setuid$GENERIC", 23},
    {"setxattr", 209},
    {"setxattr$GENERIC", 209},
    {"shutdown", 338},
    {"shutdown$GENERIC", 338},
    {"sigaltstack", 185},
    {"sigaltstack$GENERIC", 185},
    {"signalfd", 305},
    {"signalfd$GENERIC", 305},
    {"signalfd4", 313},
    {"signalfd4$GENERIC", 313},
    {"socket", 326},
    {"socket$GENERIC", 326},
    {"socket$alg", 326},
    {"socket$ax25", 326},
    ...
    {"time$GENERIC", 13},
    {"timer_create", 240},
    {"timer_create$GENERIC", 240},
    {"timer_delete", 244},
    {"timer_delete$GENERIC", 244},
    {"timer_getoverrun", 243},
    {"timer_getoverrun$GENERIC", 243},
    {"timer_gettime", 242},
    {"timer_gettime$GENERIC", 242},
    {"timer_settime", 241},
    {"timer_settime$GENERIC", 241},
    {"timerfd_create", 306},
    {"timerfd_create$GENERIC", 306},
    {"timerfd_gettime", 312},
    {"timerfd_gettime$GENERIC", 312},
    {"timerfd_settime", 311},
    {"timerfd_settime$GENERIC", 311},
    {"times", 43},
    {"times$GENERIC", 43},
    {"tkill", 208},
    {"tkill$GENERIC", 208},
    ...
    {"unlink$GENERIC", 10},
    {"unlinkat", 292},
    {"unlinkat$GENERIC", 292},
    {"unshare", 282},
    {"unshare$GENERIC", 282},
    {"uselib", 86},
    {"uselib$GENERIC", 86},
    {"userfaultfd", 364},
    {"userfaultfd$GENERIC", 364},
    {"ustat", 62},
    {"ustat$GENERIC", 62},
    {"utime", 30},
    {"utime$GENERIC", 30},
    {"utimensat", 304},
    {"utimensat$GENERIC", 304},
    {"utimes", 251},
    {"utimes$GENERIC", 251},
    {"vmsplice", 285},
    {"vmsplice$GENERIC", 285},
    {"wait4", 114},
    {"wait4$GENERIC", 114},
    {"waitid", 272},
    {"waitid$GENERIC", 272},
