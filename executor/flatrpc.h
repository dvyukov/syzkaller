...
inline const Feature (&EnumValuesFeature())[19] {
...
struct ExecRequest FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<int8_t> *prog_data() const {
    return GetPointer<const flatbuffers::Vector<int8_t> *>(VT_PROG_DATA);
  }
...
struct ExecRequestBuilder {
  ...
  void add_prog_data(flatbuffers::Offset<flatbuffers::Vector<int8_t>> prog_data) {
...
inline flatbuffers::Offset<ExecRequest> CreateExecRequest(
    flatbuffers::FlatBufferBuilder &_fbb,
    int64_t id = 0,
    flatbuffers::Offset<flatbuffers::Vector<int8_t>> prog_data = 0,
    rpc::RequestFlag flags = static_cast<rpc::RequestFlag>(0),
    rpc::ExecEnv exec_env = static_cast<rpc::ExecEnv>(0),
    rpc::ExecFlag exec_flags = static_cast<rpc::ExecFlag>(0),
    int64_t sandbox_arg = 0,
...
inline flatbuffers::Offset<ExecRequest> CreateExecRequestDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    int64_t id = 0,
    const std::vector<int8_t> *prog_data = nullptr,
    rpc::RequestFlag flags = static_cast<rpc::RequestFlag>(0),
    rpc::ExecEnv exec_env = static_cast<rpc::ExecEnv>(0),
    rpc::ExecFlag exec_flags = static_cast<rpc::ExecFlag>(0),
    int64_t sandbox_arg = 0,
    ...
    int32_t signal_filter_call = 0,
    int32_t repeat = 0) {
  auto prog_data__ = prog_data ? _fbb.CreateVector<int8_t>(*prog_data) : 0;
...
struct CallInfoBuilder {
  ...
  void add_errno(int32_t errno) {
    fbb_.AddElement<int32_t>(CallInfo::VT_ERRNO, errno, 0);
  }
...
struct ExecResult FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<int8_t> *output() const {
    return GetPointer<const flatbuffers::Vector<int8_t> *>(VT_OUTPUT);
  }
  const flatbuffers::String *error() const {
    return GetPointer<const flatbuffers::String *>(VT_ERROR);
  }
...
struct ExecResultBuilder {
  ...
  void add_output(flatbuffers::Offset<flatbuffers::Vector<int8_t>> output) {
...
inline flatbuffers::Offset<ExecResult> CreateExecResult(
    ...
    flatbuffers::Offset<flatbuffers::Vector<int8_t>> output = 0,
    flatbuffers::Offset<flatbuffers::String> error = 0,
...
inline flatbuffers::Offset<ExecResult> CreateExecResultDirect(
    ...
    const char *error = nullptr,
    flatbuffers::Offset<rpc::ProgInfo> info = 0) {
  auto output__ = output ? _fbb.CreateVector<int8_t>(*output) : 0;
  auto error__ = error ? _fbb.CreateString(error) : 0;
