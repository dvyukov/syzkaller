...
#define GOARCH "amd64"
#define SYZ_REVISION "54557ca8ce309b133f5cf72c7679d1f398126016"

unsigned syscall_count = 277;
call_t syscalls[] = {
    {"accept", 30},
    {"accept$inet", 30},
    {"accept$inet6", 30},
    ...
    {"getsockname$unix", 32},
    {"getsockopt", 118},
    {"getsockopt$inet6_IPV6_IPSEC_POLICY", 118},
    {"getsockopt$inet6_buf", 118},
    {"getsockopt$inet6_int", 118},
    {"getsockopt$inet6_mreq", 118},
    {"getsockopt$inet6_tcp_buf", 118},
    {"getsockopt$inet6_tcp_int", 118},
    {"getsockopt$inet6_udp_int", 118},
    {"getsockopt$inet_IP_IPSEC_POLICY", 118},
    ...
    {"getsockopt$inet_udp_int", 118},
    {"getsockopt$sock_buf", 118},
    ...
    {"setrlimit", 195},
    {"setsockopt", 105},
    {"setsockopt$inet6_IPV6_IPSEC_POLICY", 105},
    ...
    {"setsockopt$inet6_mreq", 105},
    {"setsockopt$inet6_tcp_buf", 105},
    {"setsockopt$inet6_tcp_int", 105},
    {"setsockopt$inet6_udp_int", 105},
    {"setsockopt$inet_IP_IPSEC_POLICY", 105},
