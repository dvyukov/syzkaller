...
#if defined(_M_X64) || 0
#define GOARCH "amd64"
#define SYZ_REVISION "540b8a60201750d5c45bbd244f70896a97e9b43d"

unsigned syscall_count = 2961;
call_t syscalls[] = {
    ...
    {"ExitWindowsEx", 0, (syscall_t)ExitWindowsEx},
    ...
    {"InitiateShutdownA", 0, (syscall_t)InitiateShutdownA},
    {"InitiateSystemShutdownA", 0, (syscall_t)InitiateSystemShutdownA},
    {"InitiateSystemShutdownExA", 0, (syscall_t)InitiateSystemShutdownExA},
    ...
    {"LockWorkStation", 0, (syscall_t)LockWorkStation},
