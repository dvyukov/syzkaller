...
var structDescs_32 = []*KeyedStruct{
	{Key: StructKey{Name: "ANY"}, Desc: &StructDesc{TypeCommon: TypeCommon{TypeName: "ANY", IsVarlen: true}, Fields: []Type{
		...
		&PtrType{TypeCommon: TypeCommon{TypeName: "ptr", FldName: "ptr", TypeSize: 4, IsOptional: true}, Type: &ArrayType{TypeCommon: TypeCommon{TypeName: "array", IsVarlen: true}, Type: &UnionType{Key: StructKey{Name: "ANY"}}}},
	...
	{Key: StructKey{Name: "ANYARG"}, Desc: &StructDesc{TypeCommon: TypeCommon{TypeName: "ANYARG", TypeSize: 8}, Fields: []Type{
		&IntType{IntTypeCommon: IntTypeCommon{TypeCommon: TypeCommon{TypeName: "intptr", FldName: "int", TypeSize: 4}}},
...
var syscalls_32 = []*Syscall{
	...
	{ID: 1, Name: "mmap$GENERIC", CallName: "mmap", Args: []Type{
		&UnionType{Key: StructKey{Name: "ANYARG"}, FldName: "a0"},
		&UnionType{Key: StructKey{Name: "ANYARG"}, FldName: "a1"},
	}},
	{ID: 2, Name: "mutate0", CallName: "mutate0"},
	{ID: 3, Name: "mutate1", CallName: "mutate1"},
	{ID: 4, Name: "mutate2", CallName: "mutate2"},
	{ID: 5, Name: "mutate3", CallName: "mutate3", Args: []Type{
	...
	{ID: 6, Name: "mutate3$GENERIC", CallName: "mutate3", Args: []Type{
		&UnionType{Key: StructKey{Name: "ANYARG"}, FldName: "a0"},
		&UnionType{Key: StructKey{Name: "ANYARG"}, FldName: "a1"},
	}},
	{ID: 7, Name: "mutate4", CallName: "mutate4", Args: []Type{
	...
	{ID: 8, Name: "mutate4$GENERIC", CallName: "mutate4", Args: []Type{
		&UnionType{Key: StructKey{Name: "ANYARG"}, FldName: "a0"},
		&UnionType{Key: StructKey{Name: "ANYARG"}, FldName: "a1"},
	}},
	{ID: 9, Name: "mutate5", CallName: "mutate5", Args: []Type{
	...
	{ID: 10, Name: "mutate5$GENERIC", CallName: "mutate5", Args: []Type{
		&UnionType{Key: StructKey{Name: "ANYARG"}, FldName: "a0"},
		&UnionType{Key: StructKey{Name: "ANYARG"}, FldName: "a1"},
	}},
	{ID: 11, Name: "mutate6", CallName: "mutate6", Args: []Type{
		&ResourceType{TypeCommon: TypeCommon{TypeName: "fd", FldName: "fd", TypeSize: 4}},
		&PtrType{TypeCommon: TypeCommon{TypeName: "ptr", FldName: "data", TypeSize: 4}, Type: &BufferType{TypeCommon: TypeCommon{TypeName: "array", IsVarlen: true}}},
		&LenType{IntTypeCommon: IntTypeCommon{TypeCommon: TypeCommon{TypeName: "bytesize", FldName: "size", TypeSize: 4}}, BitSize: 8, Buf: "data"},
	}},
	{ID: 12, Name: "mutate6$GENERIC", CallName: "mutate6", Args: []Type{
		&UnionType{Key: StructKey{Name: "ANYARG"}, FldName: "a0"},
		&UnionType{Key: StructKey{Name: "ANYARG"}, FldName: "a1"},
		&UnionType{Key: StructKey{Name: "ANYARG"}, FldName: "a2"},
	}},
	{ID: 13, Name: "mutate7", CallName: "mutate7", Args: []Type{
	...
	{ID: 14, Name: "mutate7$GENERIC", CallName: "mutate7", Args: []Type{
		&UnionType{Key: StructKey{Name: "ANYARG"}, FldName: "a0"},
		&UnionType{Key: StructKey{Name: "ANYARG"}, FldName: "a1"},
	}},
	{ID: 15, Name: "mutate8", CallName: "mutate8", Args: []Type{
	...
	{ID: 16, Name: "mutate8$GENERIC", CallName: "mutate8", Args: []Type{
		&UnionType{Key: StructKey{Name: "ANYARG"}, FldName: "a0"},
	}},
	{ID: 17, Name: "serialize0", CallName: "serialize0", Args: []Type{
		&PtrType{TypeCommon: TypeCommon{TypeName: "ptr", FldName: "a", TypeSize: 4}, Type: &StructType{Key: StructKey{Name: "serialize0_struct"}}},
	}},
	{ID: 18, Name: "serialize0$GENERIC", CallName: "serialize0", Args: []Type{
		&UnionType{Key: StructKey{Name: "ANYARG"}, FldName: "a0"},
	}},
	{ID: 19, Name: "serialize1", CallName: "serialize1", Args: []Type{
	...
	{ID: 20, Name: "serialize1$GENERIC", CallName: "serialize1", Args: []Type{
		&UnionType{Key: StructKey{Name: "ANYARG"}, FldName: "a0"},
		&UnionType{Key: StructKey{Name: "ANYARG"}, FldName: "a1"},
	}},
	{ID: 21, Name: "syz_test", CallName: "syz_test"},
	{ID: 22, Name: "syz_test$GENERIC", CallName: "syz_test", Args: []Type{
		&UnionType{Key: StructKey{Name: "ANYARG"}, FldName: "a0"},
		&UnionType{Key: StructKey{Name: "ANYARG"}, FldName: "a1"},
		&UnionType{Key: StructKey{Name: "ANYARG"}, FldName: "a2"},
	...
	{ID: 38, Name: "syz_test$csum_ipv4_udp", CallName: "syz_test", Args: []Type{
	...
	{ID: 39, Name: "syz_test$csum_ipv6_icmp", CallName: "syz_test", Args: []Type{
	...
	{ID: 40, Name: "syz_test$csum_ipv6_tcp", CallName: "syz_test", Args: []Type{
	...
	{ID: 41, Name: "syz_test$csum_ipv6_udp", CallName: "syz_test", Args: []Type{
	...
	{ID: 45, Name: "syz_test$int", CallName: "syz_test", Args: []Type{
	...
	{ID: 46, Name: "syz_test$length0", CallName: "syz_test", Args: []Type{
	...
	{ID: 47, Name: "syz_test$length1", CallName: "syz_test", Args: []Type{
	...
	{ID: 48, Name: "syz_test$length10", CallName: "syz_test", Args: []Type{
	...
	{ID: 49, Name: "syz_test$length11", CallName: "syz_test", Args: []Type{
	...
	{ID: 50, Name: "syz_test$length12", CallName: "syz_test", Args: []Type{
	...
	{ID: 51, Name: "syz_test$length13", CallName: "syz_test", Args: []Type{
	...
	{ID: 52, Name: "syz_test$length14", CallName: "syz_test", Args: []Type{
		&PtrType{TypeCommon: TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Type: &StructType{Key: StructKey{Name: "syz_length_large_struct", Dir: 2}}},
	...
	{ID: 53, Name: "syz_test$length15", CallName: "syz_test", Args: []Type{
		&IntType{IntTypeCommon: IntTypeCommon{TypeCommon: TypeCommon{TypeName: "int16", FldName: "a0", TypeSize: 2}}},
		&LenType{IntTypeCommon: IntTypeCommon{TypeCommon: TypeCommon{TypeName: "len", FldName: "a1", TypeSize: 4}}, Buf: "a0"},
	}},
	{ID: 54, Name: "syz_test$length16", CallName: "syz_test", Args: []Type{
	...
	{ID: 55, Name: "syz_test$length17", CallName: "syz_test", Args: []Type{
	...
	{ID: 56, Name: "syz_test$length18", CallName: "syz_test", Args: []Type{
	...
	{ID: 59, Name: "syz_test$length20", CallName: "syz_test", Args: []Type{
	...
	{ID: 60, Name: "syz_test$length21", CallName: "syz_test", Args: []Type{
	...
	{ID: 65, Name: "syz_test$length26", CallName: "syz_test", Args: []Type{
	...
	{ID: 66, Name: "syz_test$length3", CallName: "syz_test", Args: []Type{
	...
	{ID: 67, Name: "syz_test$length4", CallName: "syz_test", Args: []Type{
	...
	{ID: 68, Name: "syz_test$length5", CallName: "syz_test", Args: []Type{
	...
	{ID: 69, Name: "syz_test$length6", CallName: "syz_test", Args: []Type{
	...
	{ID: 70, Name: "syz_test$length7", CallName: "syz_test", Args: []Type{
	...
	{ID: 71, Name: "syz_test$length8", CallName: "syz_test", Args: []Type{
	...
	{ID: 72, Name: "syz_test$length9", CallName: "syz_test", Args: []Type{
	...
	{ID: 73, Name: "syz_test$missing_resource", CallName: "syz_test", Ret: &ResourceType{TypeCommon: TypeCommon{TypeName: "syz_missing_const_res", FldName: "ret", TypeSize: 4, ArgDir: 1}}},
	{ID: 74, Name: "syz_test$opt0", CallName: "syz_test", Args: []Type{
		&IntType{IntTypeCommon: IntTypeCommon{TypeCommon: TypeCommon{TypeName: "intptr", FldName: "a0", TypeSize: 4, IsOptional: true}}},
	}},
	{ID: 75, Name: "syz_test$opt1", CallName: "syz_test", Args: []Type{
	...
	{ID: 82, Name: "syz_test$regression1", CallName: "syz_test", Args: []Type{
	...
	{ID: 83, Name: "syz_test$regression2", CallName: "syz_test", Args: []Type{
	...
	{ID: 84, Name: "syz_test$res0", CallName: "syz_test", Ret: &ResourceType{TypeCommon: TypeCommon{TypeName: "syz_res", FldName: "ret", TypeSize: 4, ArgDir: 1}}},
	{ID: 85, Name: "syz_test$res1", CallName: "syz_test", Args: []Type{
		&ResourceType{TypeCommon: TypeCommon{TypeName: "syz_res", FldName: "a0", TypeSize: 4}},
	}},
	{ID: 86, Name: "syz_test$struct", CallName: "syz_test", Args: []Type{
		&PtrType{TypeCommon: TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Type: &StructType{Key: StructKey{Name: "syz_struct0"}}},
	}},
	{ID: 87, Name: "syz_test$syz_union3", CallName: "syz_test", Args: []Type{
		&PtrType{TypeCommon: TypeCommon{TypeName: "ptr", FldName: "a0", TypeSize: 4}, Type: &UnionType{Key: StructKey{Name: "syz_union3"}}},
	}},
	{ID: 88, Name: "syz_test$syz_union4", CallName: "syz_test", Args: []Type{
		&UnionType{Key: StructKey{Name: "union_arg"}, FldName: "a0"},
	}},
	{ID: 89, Name: "syz_test$text_x86_16", CallName: "syz_test", Args: []Type{
	...
	{ID: 90, Name: "syz_test$text_x86_32", CallName: "syz_test", Args: []Type{
	...
	{ID: 91, Name: "syz_test$text_x86_64", CallName: "syz_test", Args: []Type{
	...
	{ID: 92, Name: "syz_test$text_x86_real", CallName: "syz_test", Args: []Type{
...
const revision_32 = "3815998d66128dad9531430669440fec0bed0476"
