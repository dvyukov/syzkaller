...
var arm = &Subsystem{
	...
	PathRules: []PathRule{
		...
		{IncludeRegexp: "^arch/arm64/boot/dts/ti/Makefile$|^arch/arm64/boot/dts/ti/k3-(?:[^/]*)$|^include/dt-bindings/pinctrl/k3\\.h$"},
...
var dm = &Subsystem{
	...
	Parents: []*Subsystem{kernel},
	PathRules: []PathRule{
		{IncludeRegexp: "^drivers/md/Kconfig$|^drivers/md/Makefile$|^drivers/md/dm(?:[^/]*)$|^drivers/md/persistent-data(?:/.*)?$|^include/linux/device-mapper\\.h$|^include/linux/dm-(?:[^/]*)\\.h$|^include/uapi/linux/dm-(?:[^/]*)\\.h$"},
	},
}
...
var scsi = &Subsystem{
	...
	PathRules: []PathRule{
		...
		{IncludeRegexp: "^drivers/scsi/smartpqi/Kconfig$|^drivers/scsi/smartpqi/Makefile$|^drivers/scsi/smartpqi/smartpqi(?:[^/]*)\\.\\[ch\\]$|^include/linux/cciss(?:[^/]*)\\.h$|^include/uapi/linux/cciss(?:[^/]*)\\.h$"},
...
var spdx = &Subsystem{
	...
	Parents: []*Subsystem{kernel},
	PathRules: []PathRule{
		{IncludeRegexp: "^COPYING$|^LICENSES(?:/.*)?$"},
	},
}
...
var sysv = &Subsystem{
	...
	Parents:     []*Subsystem{fs},
	PathRules: []PathRule{
		{IncludeRegexp: "^fs/sysv(?:/.*)?$|^include/linux/sysv_fs\\.h$"},
	},
}
...
var usb = &Subsystem{
	...
	PathRules: []PathRule{
		...
		{IncludeRegexp: "^drivers/phy/sunplus/Kconfig$|^drivers/phy/sunplus/Makefile$|^drivers/phy/sunplus/phy-sunplus-usb2\\.c$"},
		{IncludeRegexp: "^drivers/staging/media/deprecated/zr364xx(?:/.*)?$"},
